        ...
        children: [
          Container(
            ...
            decoration:  BoxDecoration(
              ...
              color: (lstData[index].isOk == true)? const Color(0xFF2088B4):Colors.orange,
            ...
            child:  Center(
              child: Padding(
                padding:  const EdgeInsets.all(4.0),
                child:  (lstData[index].isOk == true)? const Icon(Icons.done,size: 10,color: Colors.white,):
                const FaIcon(
           ...
           Text(lstData[index].day??"",style:TextStyles(context).googleRubikFontsForButtonText(fontWeight: FontWeight.w500,fontSize: 10) ,)
        ],
            ),
...
class WeekDataModel{
  ...
  WeekDataModel({this.day,this.isOk});
}